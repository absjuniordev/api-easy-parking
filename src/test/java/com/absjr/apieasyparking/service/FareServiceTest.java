...
class FareServiceTest {
    ...
    void calculateFare() {
        ...
        fare.setStartOvernight(0); // Início da tarifa noturna
        ...
        LocalDateTime departureTime = LocalDateTime.parse("2025-03-29T08:00:00");
        ...
        BigDecimal expectedFare = BigDecimal.valueOf(10) // Valor base para carro
                .add(BigDecimal.valueOf(21)) // Valor adicional para carro
                .add(BigDecimal.valueOf(0)); // Valor noturno para carro (considerando que a estadia é durante a noite)
